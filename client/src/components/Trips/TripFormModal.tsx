  ...
  return (
    ...
    >
      {pendingDateShift && (
        <div className="space-y-3">
          ...
          {[
            ...
            <label
              key={mode}
              className={`flex cursor-pointer items-start gap-3 rounded-lg border p-3 transition-colors ${dateShiftMode === mode ? 'border-slate-900 bg-slate-50' : 'border-slate-200 hover:bg-slate-50'}`}
            >
              <input
                type="radio"
      ...
      <form onSubmit={handleSubmit} className={pendingDateShift ? 'hidden' : 'space-y-4'} onPaste={handlePaste}>
          ...
          <div>
            ...
            <div className="mt-2 flex gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 whitespace-nowrap rounded-lg border border-slate-200 px-3 py-2 text-sm hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40"
              >
                {searchingCover ? (
            ...
            {coverSearchError && <p className="mt-1.5 text-xs text-red-500">{coverSearchError}</p>}
        ...
        <div>
          <label className="mb-1.5 block text-sm font-medium text-slate-700">{t('dashboard.currency')}</label>
          <CustomSelect
