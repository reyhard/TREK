...
const sampleLegs = [
  { mode: 'WALK', duration: 300, from: { name: 'Start' }, to: { name: 'Station' } },
  {
    ...
    stops: 4,
    headsign: 'Ruhleben',
    from: { name: 'Station', time: '08:30', track: '2' },
    to: { name: 'Zoo', time: '08:40' },
  },
];
...
describe('TransitItineraryInline', () => {
  ...
  it('FE-TRANSDISPLAY-007: handles malformed optional metadata without throwing', () => {
    const badLegs = [
      { mode: 'BUS', line: undefined, duration: undefined, from: { name: undefined }, to: { name: 'Dest' } },
    ];
  ...
  it('FE-TRANSDISPLAY-008: multi-day leg shows different departure/arrival labels', () => {
    const multiDayLeg = {
      ...
      line: 'ICE',
      duration: 7200,
      from: { name: 'Berlin', time: '22:30' },
      to: { name: 'Paris', time: '08:30' },
    };
