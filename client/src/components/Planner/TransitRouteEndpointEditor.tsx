import type { ReservationEndpoint } from '@trek/shared';
...
export interface TransitRouteEndpointEditInput {
...
interface TransitRouteEndpointEditorProps {
  ...
  onSave: (input: TransitRouteEndpointEditInput) => Promise<unknown>;
  onCancel: () => void;
}
...
export default function TransitRouteEndpointEditor({ from, to, onSave, onCancel }: TransitRouteEndpointEditorProps) {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    setSaveError(null);
    const input: TransitRouteEndpointEditInput = {};
