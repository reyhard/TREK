  ...
  return (
    <div className="border-b border-edge-faint" style={{ padding: '12px 16px', flexShrink: 0 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 8 }}>
        ...
        <div style={{ position: 'relative', flexShrink: 0 }} onMouseEnter={showIcsMenu} onMouseLeave={hideIcsMenu}>
          <button
            style={{
              display: 'flex',
              alignItems: 'center',
          ...
          {icsMenuVisible && (
            ...
            >
              <button
                ...
                style={menuItemStyle}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = 'var(--bg-hover, #f3f4f6)';
                }}
                onMouseLeave={(e) => {
