        ...
        {(() => {
          ...
          if (meta.price != null && meta.price !== '')
            cells.push({
              ...
              value: `${meta.price}${meta.priceCurrency ? ' ' + meta.priceCurrency : ''}`,
            });
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '24px 28px 80px' }} className="max-md:!px-4 max-md:!pt-4">
        {total === 0 && reservations.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <p
              className="text-content-secondary"
              style={{ fontSize: 'calc(14px * var(--fs-scale-body, 1))', fontWeight: 600, margin: '0 0 4px' }}
            >
              {t('reservations.empty')}
            </p>
            <p className="text-content-faint" style={{ fontSize: 'calc(12px * var(--fs-scale-body, 1))', margin: 0 }}>
