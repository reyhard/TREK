...
import { visibleReservationEndpointPoints, visibleRouteReservations } from '../../utils/reservationRoutes';
...
export const MapView = memo(function MapView({
  ...
  const activeRepositionPlaceId =
    canRepositionPlaces && selectedPlaceId === repositionPlaceId ? repositionPlaceId : null;
  ...
  const repositionMarker = useMemo(
    () =>
      activeRepositionPlaceId != null
        ? markers.find((marker) => marker.props.place.id === activeRepositionPlaceId)
        : null,
    [markers, activeRepositionPlaceId]
  );
      ...
      <div className="relative h-full w-full">
        ...
        >
          ...
          <BoundsController
            ...
            reservationEndpointCoords={reservationEndpointCoords}
          />
          <SelectionController
            places={places}
