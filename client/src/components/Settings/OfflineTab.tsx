 ...
 *   - Cache stats + clear.
 */
import { Check, CloudOff, Database, Download, GitMerge, Map as MapIcon, RefreshCw, Trash2 } from 'lucide-react';
import React, { useCallback, useEffect, useState } from 'react';
import { tripsApi } from '../../api/client';
import type { QueuedMutation, SyncMeta } from '../../db/offlineDb';
import { clearAll, clearTripData, offlineDb } from '../../db/offlineDb';
    ...
    try {
      ...
      try {
        const trips = isEffectivelyOffline()
          ...
          : await tripsApi
              .list()
              .then((r) => (r as { trips: Trip[] }).trips)
              .catch(() => offlineDb.trips.toArray());
