            ...
            <div className="hidden md:block" style={{ position: 'absolute', left: 10, top: 10, bottom: 10, zIndex: 20 }}>
              ...
              <div style={{
                ...
                <DayPlanSidebar
                  ...
                  onPlanTransit={can('day_edit', trip) && tripHasDates ? (dayId, prefill) => { setTransportModalDayId(dayId); setEditingTransport(null); setTransitPrefill(prefill ?? null); setTransportModalAutomated(true); setShowTransportModal(true) } : undefined}
                  onEditTransport={can('day_edit', trip) ? (reservation) => { setEditingTransport(reservation); setTransportModalDayId(reservation.day_id ?? null); setTransitPrefill(null); setTransportModalAutomated(false); setShowTransportModal(true) } : undefined}
        ...
        {activeTab === 'transports' && (
          <div style={{ height: '100%', width: '100%', display: 'flex', flexDirection: 'column', overflowY: 'auto', overscrollBehavior: 'contain', paddingBottom: 'var(--bottom-nav-h)' }}>
            <ReservationsPanel
              ...
              onEdit={(r) => { if (r.type === 'transit') { setTransitJourney(r) } else { setEditingTransport(r); setTransitPrefill(null); setTransportModalAutomated(false); setShowTransportModal(true) } }}
