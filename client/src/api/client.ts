...
import {
  ...
  type TransitRouteEndpointsUpdateRequest, type TransitRouteEndpointsUpdateResponse,
...
export const reservationsApi = {
  ...
  updateTransitRouteEndpoints: (
    ...
    apiClient.put(`/trips/${tripId}/reservations/${id}/transit-endpoints`, data).then(r => r.data as TransitRouteEndpointsUpdateResponse),
