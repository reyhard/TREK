...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.geo:read.label': 'الخرائط والترميز الجغرافي والنقل العام',
  'oauth.scope.geo:read.description': 'البحث عن مواقع وحل عناوين الخرائط والترميز الجغرافي العكسي للإحداثيات والبحث عن مسارات النقل العام',
