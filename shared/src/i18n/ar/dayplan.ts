...
const dayplan: TranslationStrings = {
  ...
  'dayplan.movement.walking': 'Walking',
  'dayplan.movement.driving': 'Driving',
  'dayplan.movement.total': '{mode} movement total',
  'dayplan.movement.incomplete': 'Some segments have incomplete movement statistics. Values with ≥ are known minimums.',
