...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.geo:read.label': 'Mapes, geocodificació i transport públic',
  'oauth.scope.geo:read.description': 'Cerca llocs, resol URLs de mapa, geocodifica coordenades i cerca rutes de transport públic',
